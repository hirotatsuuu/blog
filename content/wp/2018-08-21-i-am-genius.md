...
## <span id="IQ-2">IQ測定</span>

Google先生に「IQ テスト」って調べる。
...
なんか、いろいろとIQテストをやってみましたが、ホントかどうかあやしいです。
  
実際、時間とか気にしてなかったのだけれど、、本当は制限時間とかありそう。。。

ま、でも「天才」って評価されるのは嬉しいねｗ（単純ｗ
